...
# Visualize the association between gender and promotion
    ...
    st.markdown("Ou encore pour comparer l'efficacité de différentes initiatives pour améliorer l'engagement des employés ; pour comparer les performances des employés dans plusieurs services, etc... ") 
