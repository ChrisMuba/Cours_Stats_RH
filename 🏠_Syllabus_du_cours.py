...
st.caption("Vous souhaitez faire analyser vos data RH, ou bénéficier d'un tutorat personnalisé ?") 
st.caption("parlons-en 📧 : https://www.linkedin.com/in/chris-muba-io 🌍")
