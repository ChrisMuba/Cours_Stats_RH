...
if st.button("Continuer vers la suite du Chap.1 - **B/ Types de données et sources de données**"):
    ...
    st.markdown("⚠️Des données **catégorielles** peuvent être **quantitatives** car elles peuvent être quantifiées ou décrites à l'aide de méthodes numériques : calculs de fréquences, pourcentages, tests du khi-deux, etc... pour résumer et analyser les données catégorielles ; l'analyse de clustering ou l'analyse factorielle pour identifier des modèles et des relations dans les données catégorielles.")  
