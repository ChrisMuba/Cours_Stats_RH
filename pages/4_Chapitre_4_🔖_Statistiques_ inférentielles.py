...
if st.button("Cliquez pour acceder au Chap.4 - **A/ Estimation**"):
    ...
    st.markdown("- **L'estimation ponctuelle** consiste à utiliser une seule valeur pour estimer le paramètre de la population.") 
    st.markdown("Par exemple, si nous voulons estimer le salaire moyen d'une population, nous pouvons calculer le salaire moyen des employés d'une entreprise (échantillon) et l'utiliser comme estimation de la moyenne de la population (la population peut être toutes les entreprises de la branche d'activité).")
