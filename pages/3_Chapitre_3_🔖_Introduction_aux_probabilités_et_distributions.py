...
st.markdown("La **théorie des probabilité** est la branche des mathématiques qui **quantifie la possibilité qu'un événement particulier se produise** (événement aléatoire). Cette possibilité est exprimée sous la forme d'un nombre compris entre 0 et 1.")
