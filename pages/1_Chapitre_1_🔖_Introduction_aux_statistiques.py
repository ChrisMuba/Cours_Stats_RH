...
if st.button("Continuer vers la suite du Chap.1 - **B/ Types de données et sources de données**"):
    ...
    st.markdown("Les données **catégorielles** sont des données qui peuvent être **triées en catégories ou en groupes**. Ces catégories sont généralement non numériques et peuvent être **qualitatives** ou **quantitatives**. Des exemples de données catégorielles en Ressources Humaines incluent par exemple **le genre** : 👦🏾/👧 ; le **titre du poste**: **contrôleur de gestion sociale**, **responsable formation**, etc... ; le **rattachement du poste** : **administration des RH**, **développement des RH**, etc...") 
...
# Afficher les images
    ...
    with col1:
       ...
       st.image("https://raw.githubusercontent.com/ChrisMuba/Cours_Stats_RH/main/dossiers_employes.jpg") 

    with col2:
       st.markdown("quelques SIRH")
       st.image("https://raw.githubusercontent.com/ChrisMuba/Cours_Stats_RH/main/photos_sirh.jpg")
