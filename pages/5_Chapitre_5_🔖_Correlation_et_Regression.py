...
if st.button("Continuer vers la suite du Chap.5 - **C/ Régression multiple : prise en compte de plusieurs facteurs**"):
    ...
    st.markdown("- **Analyse de régression** : vous analysez les données pour estimer les coefficients (b0, b1, b2, b3 etc...) qui correspondent le mieux à vos données et décrire la relation entre les variables.")
